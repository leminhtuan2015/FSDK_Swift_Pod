...
class PaymentTelcoViewController: BasicViewController {
    ...
    private func prepareData(){
        ...
        PaymentTelco.getTelcoesType(productCode: FujiSDK.PRODUCT_CODE, callback: callback)
    }
    ...
    private func renderButtonTelco(telcoTypes: [String]){
        for telcoType in telcoTypes {
            ...
            button.setImage(UIImage(named: imageName, in: fujiSdkBundle, compatibleWith: nil), for: UIControlState.normal)
    ...
    @objc private func clickedButtonTelcoType(sender: UIButton){
        ...
        for button in self.stackView.subviews {
            ...
            let imageName = getImageNameByType(telcoType: b.currentTitle!, isDisabled: true)
            b.setImage(UIImage(named: imageName, in: fujiSdkBundle, compatibleWith: nil), for: UIControlState.normal)
        }
        
        let imageName = getImageNameByType(telcoType: sender.currentTitle!, isDisabled: false)
        
        sender.setImage(UIImage(named: imageName, in: fujiSdkBundle, compatibleWith: nil), for: UIControlState.normal)
    }
    ...
    private func submit(){
        ...
        paymentTelco.setProductCode(productCode: FujiSDK.PRODUCT_CODE)
