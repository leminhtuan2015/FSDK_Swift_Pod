...
class BasicViewController: UIViewController, UITextFieldDelegate {
    ...
    let fujiSdkBundle = Bundle(path: Bundle(for: LoginViewController.classForCoder()).path(forResource: "FujiSDK", ofType: "bundle")!)
    ...
    func setImageLogo(imageViewLogo: UIImageView){
        imageViewLogo.image = UIImage(named: Constant.LOGO_IMAGE_NAME, in: fujiSdkBundle, compatibleWith: nil)
    }
