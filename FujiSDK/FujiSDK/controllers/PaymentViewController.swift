...
class PaymentViewController: BasicViewController {
    ...
    var callback: (_ isSuccess: Bool, _ message: String, _ fcoin: Int) -> Void = {_ in
    }
...
//                Logger.log(string: serverCodes.description)
        ...
        Payment.getServerCode(productCode: FujiSDK.PRODUCT_CODE, callback: callbackGetServerCodes)
        Package.getPackages(productCode: FujiSDK.PRODUCT_CODE, callback: callbackGetPackage)
    }
    ...
    private func buyByFcoin(){
        ...
        let payment: Payment = Payment.init(token: User.getCurrentUser().getToken(),
                                            ...
                                            productCode: FujiSDK.PRODUCT_CODE,
                                            paymentTelco: "",
        ...
        func callback(isSuccess: Bool, message: String) {
            ...
            self.callback(isSuccess, message, (packageBuying?.getFcoinMinus())!)
        }
